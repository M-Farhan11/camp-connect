...
(function () {
  ...
  function programHtml(data) {
    return (
      ...
      '<a class="btn btn-primary" href="contact.html">Ask about this program</a>' +
  ...
  function serviceHtml(data) {
    return (
      ...
      '<div class="modal-actions">' +
      '<a class="btn btn-primary" href="contact.html">Contact this office</a>' +
      "</div>"
    );
  }
  ...
  function initCourseFilter() {
    ...
    var list = $("#courseList");
    if (!search || !department || !list) return;

    var cards = $$(".course-card", list);
    ...
    function apply() {
      ...
      count.textContent = "Showing " + visible + (visible === 1 ? " program" : " programs");
  ...
  function initEnquiryForm() {
    ...
    // Registration numbers look like 2023-SE-045 or FA22-BSE-100
    // (year or session - department - roll no).
    var REG_PATTERN = /^(\d{4}|[A-Za-z]{2}\d{2})-[A-Za-z]{2,4}-\d{2,4}$/;
